    ...
    >
        ...
        <div class="absolute -top-2 left-1/2 transform -translate-x-1/2 z-20">
            <button
                ...
                class="relative group overflow-hidden bg-gradient-to-br from-green-500 via-emerald-500 to-teal-600 hover:from-green-400 hover:via-emerald-400 hover:to-teal-500 text-white px-3 py-1.5 rounded-lg font-bold text-sm shadow-xl transition-all hover:scale-105 border-2 border-purple-600"
            >
