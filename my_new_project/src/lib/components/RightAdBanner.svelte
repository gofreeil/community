...
<aside
    aria-label="פרסומות"
    class="hidden xl:block w-36 absolute top-8 right-8 pb-8 text-center"
>
    <h4
    ...
    <div class="space-y-3">
        {#each displayedAds as ad, index}
            <div
                class="h-[300px] flex flex-col items-center justify-center rounded-2xl border-2 border-dashed {ad.borderColor} {ad.bgColor} p-3 text-center transition-all {ad.hoverBorder} {ad.hoverBg} group duration-700 relative overflow-hidden"
