<script lang="ts">
    ...
    const messages: ChatMessage[] = [
        { id: 1, name: 'דנה כהן', text: 'מישהו יודע למה הכביש חסום הבוקר ליד הכיכר?', time: '08:15' },
        { id: 2, name: 'משה לוי', text: 'עבודות תשתית, אמרו שזה ייפתח בערך בעשר 🙂', time: '08:22' },
        { id: 3, name: 'רבקה פרידמן', text: 'אביגיל שינתה לסטטוס יולדת - היכן מצטרפים לבישולים עבורה?', time: '09:10' },
        { id: 4, name: 'יוסי אברהם', text: 'יש חשוד שמסתובב ליד גן הילדים, מי פנוי להגיע להראות שם נוכחות?', time: '09:48' }
    ];
