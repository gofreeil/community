...
<div class="rounded-xl bg-black/20 border border-white/10 px-3 py-2 text-sm space-y-1">
	...
	{#if phone || email || business}
		<div class="flex items-center gap-x-3 gap-y-0.5 flex-wrap text-gray-400 text-[13px]">
			{#if phone}<a href="tel:{phone}" dir="ltr" class="underline hover:text-white inline-flex items-center gap-1"><svg class="w-3.5 h-3.5 text-green-400 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M6.62 10.79c1.44 2.83 3.76 5.15 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.32.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>{phone}</a>{/if}
