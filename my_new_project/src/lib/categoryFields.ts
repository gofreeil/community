...
export const categoryConfig: Record<string, CategoryConfig> = {
    ...
    singles: {
        ...
        fields: [
            ...
            { key: 'looking_for_m', label: 'מחפש',                  type: 'textarea', required: false, placeholder: 'למשל: רגישה, חכמה, יראת שמיים, עם חוש הומור...', maxLength: 1000, showIf: { field: 'gender', equals: 'גבר' } },
            { key: 'looking_for_f', label: 'מחפשת',                 type: 'textarea', required: false, placeholder: 'למשל: רגיש, חכם, ירא שמיים, עם חוש הומור...',  maxLength: 1000, showIf: { field: 'gender', equals: 'אישה' } },
