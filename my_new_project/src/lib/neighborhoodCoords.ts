...
export const cityCenters: Record<string, Coord> = {
    ...
    // ---- נוספו 22.9.2026 עם ייבוא הרשומים מרכישות קבוצתיות: 241 ערים של המיובאים לא היו כאן,
    // והמפה הציבה את כולם בירושלים. גיאוקוד Nominatim (תוצאות מסוג יישוב בלבד) + תיקונים ידניים. ----
    'אבו גוש':            [31.8064, 35.1089],
    'אביאל':              [32.5325, 34.9934],
    'אבן יהודה':          [32.2711, 34.8894],
    'אבני חפץ':           [32.2847, 35.0736],
    'אדמית':              [33.0796, 35.2103],
    'אודים':              [32.2648, 34.8469],
    'אור הגנוז':          [33.0051, 35.4475],
    'אורנית':             [32.1309, 34.9920],
    'אזור':               [32.0282, 34.8026],
    'אחיעזר':             [31.9811, 34.8717],
    'אייל':               [32.2114, 34.9790],
    'אלוני אבא':          [32.7310, 35.1714],
    'אלי-עד':             [32.8047, 35.7342],
    'אליעד':              [32.9884, 35.6771],
    'אליקים':             [32.6327, 35.0671],
    'אלישיב':             [32.3803, 34.9092],
    'אלעזר':              [31.6607, 35.1415],
    'אלפי מנשה':          [32.1731, 35.0158],
    'אמירים':             [32.9375, 35.4500],
    'אמנון':              [32.9043, 35.5705],
    'אניעם':              [32.9569, 35.7398],
    'אשבול':              [31.4475, 34.6664],
    'בורגתה':             [32.3265, 34.9629],
    'בית אורן':           [32.7306, 35.0056],
    'בית אל':             [31.9421, 35.2224],
    'בית אלעזרי':         [31.8461, 34.8031],
    'בית אריה-עופרים':    [32.0341, 35.0502],
    'בית דגן':            [32.0019, 34.8302],
    'בית הגדי':           [31.4239, 34.6067],
    'בית הלל':            [33.2083, 35.6069],
    'בית השיטה':          [32.5511, 35.4382],
    'בית זית':            [31.7826, 35.1593],
    'בית חורון':          [31.8782, 35.1268],
    'בית חלקיה':          [31.7927, 34.8108],
    'בית חשמונאי':        [31.8889, 34.9165],
    'בית לחם הגלילית':    [32.7346, 35.1891],
    'בית עזרא':           [31.7366, 34.6564],
    'בית קשת':            [32.7191, 35.3943],
    'בית רבן':            [31.8168, 34.7281],
    'בית שקמה':           [31.6375, 34.6105],
    'ביתר עילית':         [31.7019, 35.1073],
    'בני דרור':           [32.2619, 34.9002],
    'בני יהודה':          [32.7984, 35.6902],
    'בני נצרים':          [31.1410, 34.3147],
    'בנימינה-גבעת עדה':   [32.5203, 34.9436],
    'ברוכין':             [32.0821, 35.0907],
    'ברקאי':              [32.4751, 35.0300],
    'ברקת':               [32.0189, 34.9438],
    'בת חפר':             [32.3345, 35.0124],
    'בת עין':             [31.6573, 35.1032],
    'בת שלמה':            [32.5994, 35.0030],
    'גבע כרמל':           [32.6636, 34.9550],
    'גבעת זאב':           [31.8608, 35.1703],
    'גבעת חיים (איחוד)':  [32.4003, 34.9330],
    'גבעת יערים':         [31.7860, 35.0926],
    'גבת':                [32.6747, 35.2108],
    'גונן':               [33.1239, 35.6463],
    'גינוסר':             [32.8475, 35.5233],
    'גלאון':              [31.6341, 34.8490],
    'גמזו':               [31.9277, 34.9419],
    'גן יבנה':            [31.7871, 34.7097],
    'גן נר':              [32.5309, 35.3391],
    'געתון':              [33.0057, 35.2138],
    'גת (קיבוץ)':         [31.6297, 34.7947],
    'דבורה':              [32.5531, 35.2635],
    'דביר':               [31.4135, 34.8233],
    'דגניה א\'':          [32.7085, 35.5749],
    'דורות':              [31.5066, 34.6460],
    'דן':                 [33.2401, 35.6531],
    'דפנה':               [33.2304, 35.6393],
    'הבונים':             [32.6372, 34.9328],
    'הגושרים':            [33.2211, 35.6231],
    'הושעיה':             [32.7586, 35.2933],
    'החותרים':            [32.7515, 34.9568],
    'הילה':               [33.0358, 35.2443],
    'הר אדר':             [31.8269, 35.1296],
    'הרדוף':              [32.7641, 35.1728],
    'הררית':              [32.8458, 35.3692],
    'זבדיאל':             [31.6584, 34.7597],
    'זכרון יעקב':         [32.5712, 34.9530],
    'חגלה':               [32.3878, 34.9273],
    'חד-נס':              [32.9284, 35.6430],
    'חדיד':               [31.9682, 34.9337],
    'חולדה':              [31.8311, 34.8828],
    'חוקוק':              [32.8800, 35.4945],
    'חפץ חיים':           [31.7888, 34.8000],
    'חצור הגלילית':       [32.9792, 35.5433],
    'חצור-אשדוד':         [31.7731, 34.7210],
    'חרב לאת':            [32.4013, 34.9171],
    'חריש':               [32.4596, 35.0511],
    'חרמש':               [32.4232, 35.1188],
    'חשמונאים':           [31.9312, 35.0224],
    'טירת יהודה':         [32.0141, 34.9334],
    'טירת כרמל':          [32.7614, 34.9716],
    'טל שחר':             [31.8051, 34.9022],
    'טלמון':              [31.9394, 35.1323],
    'טנא עומרים':         [31.3757, 34.9573],
    'יבנאל':              [32.7055, 35.5053],
    'יד בנימין':          [31.7978, 34.8216],
    'יחיעם':              [32.9967, 35.2205],
    'יסוד המעלה':         [33.0574, 35.6030],
    'יציץ':               [31.8623, 34.8630],
    'ירוחם':              [30.9888, 34.9251],
    'ירחיב':              [32.1531, 34.9683],
    'ישרש':               [31.9158, 34.8499],
    'כדיתה':              [33.0066, 35.4668],
    'כוכב השחר':          [31.9603, 35.3495],
    'כוכב יאיר-צור יגאל': [32.2202, 34.9940],
    'כוכב יעקב':          [31.8814, 35.2453],
    'כורזים':             [32.9110, 35.5527],
    'כליל':               [32.9855, 35.2005],
    'כמון':               [32.9114, 35.3613],
    'כסלון':              [31.7741, 35.0492],
    'כפר אביב':           [31.8318, 34.7213],
    'כפר אדומים':         [31.8253, 35.3352],
    'כפר ברוך':           [32.6460, 35.1930],
    'כפר הס':             [32.2458, 34.9340],
    'כפר ויתקין':         [32.3809, 34.8752],
    'כפר ורדים':          [32.9973, 35.2725],
    'כפר טרומן':          [31.9806, 34.9217],
    'כפר יונה':           [32.3145, 34.9321],
    'כפר יחזקאל':         [32.5683, 35.3624],
    'כפר שמואל':          [31.8891, 34.9328],
    'כפר תבור':           [32.6878, 35.4204],
    'כרמי יוסף':          [31.8470, 34.9205],
    'כרמיאל':             [32.9159, 35.2934],
    'מבוא דותן':          [32.4207, 35.1748],
    'מבועים':             [31.4493, 34.6548],
    'מבשרת ציון':         [31.8057, 35.1527],
    'מגדים':              [32.7290, 34.9626],
    'מגל':                [32.3852, 35.0352],
    'מדרשת בן גוריון':    [30.8516, 34.7826],
    'מוצא עילית':         [31.7935, 35.1566],
    'מורן':               [32.9216, 35.3935],
    'מורשת':              [32.8268, 35.2329],
    'מזרעה':              [32.9833, 35.0983],
    'מחולה':              [32.3652, 35.5156],
    'מחסיה':              [31.7482, 35.0074],
    'מטולה':              [33.2800, 35.5779],
    'מטע':                [31.7169, 35.0616],
    'מירון':              [32.9886, 35.4403],
    'מיתר':               [31.3271, 34.9384],
    'מכמורת':             [32.4063, 34.8729],
    'מעברות':             [32.3639, 34.9047],
    'מעוז חיים':          [32.4934, 35.5513],
    'מעלה אפרים':         [32.0708, 35.4034],
    'מעלה גמלא':          [32.8899, 35.6849],
    'מעלות-תרשיחא':       [33.0157, 35.2760],
    'מענית':              [32.4560, 35.0281],
    'מצדות יהודה':        [31.3655, 35.1117],
    'מצובה':              [33.0629, 35.1571],
    'מצפה יריחו':         [31.8155, 35.3943],
    'מצפה נטופה':         [32.8028, 35.3830],
    'מצפה רמון':          [30.6120, 34.8012],
    'משגב דב':            [31.8196, 34.7399],
    'משהד':               [32.7402, 35.3245],
    'משכיות':             [32.3173, 35.5025],
    'משמר דוד':           [31.8225, 34.9009],
    'נהורה':              [31.6227, 34.7047],
    'נוב':                [32.8323, 35.7832],
    'נווה':               [31.1621, 34.3301],
    'נווה אילן':          [31.8085, 35.0763],
    'נווה ירק':           [32.1333, 34.9242],
    'נוף איילון':         [31.8705, 34.9897],
    'נופי פרת':           [31.8238, 35.3208],
    'נוקדים':             [31.6450, 35.2441],
    'נחשון':              [31.8310, 34.9559],
    'נטועה':              [33.0649, 35.3233],
    'ניצן':               [31.7399, 34.6318],
    'ניר דוד (תל עמל)':   [32.5027, 35.4567],
    'נעלה':               [31.9630, 35.0646],
    'נשר':                [32.7709, 35.0381],
    'ספיר':               [30.6141, 35.1846],
    'עגור':               [31.6971, 34.9129],
    'עולש':               [32.3317, 34.9862],
    'עומר':               [31.2659, 34.8476],
    'עזר':                [31.7365, 34.6714],
    'עזריקם':             [31.7538, 34.6949],
    'עין איילה':          [32.6287, 34.9454],
    'עין הבשור':          [31.2806, 34.4438],
    'עין הוד':            [32.7005, 34.9826],
    'עין החורש':          [32.3863, 34.9400],
    'עין העמק':           [32.6290, 35.0854],
    'עין חרוד (איחוד)':   [32.5592, 35.3936],
    'עין יהב':            [30.6569, 35.2382],
    'עין שמר':            [32.4629, 35.0074],
    'עינת':               [32.0828, 34.9394],
    'עלי':                [32.0695, 35.2625],
    'עלי זהב':            [32.0711, 35.0634],
    'עלמון':              [31.8316, 35.2965],
    'עמנואל':             [32.1619, 35.1361],
    'ענב':                [31.3970, 34.9278],
    'עפרה':               [31.9535, 35.2605],
    'עץ אפרים':           [32.1192, 35.0469],
    'ערד':                [31.2612, 35.2146],
    'עתלית':              [32.6907, 34.9423],
    'פלמחים':             [31.9334, 34.7073],
    'פרדס חנה-כרכור':     [32.4750, 34.9751],
    'פרדסיה':             [32.3070, 34.9098],
    'צוחר':               [31.2361, 34.4271],
    'צופים':              [32.1982, 35.0097],
    'צופית':              [32.1918, 34.9231],
    'צוקים':              [30.4910, 35.1659],
    'צור הדסה':           [31.7157, 35.0948],
    'צור משה':            [32.2978, 34.9135],
    'צורית':              [32.9023, 35.2535],
    'צפריה':              [32.0053, 34.8551],
    'קדומים':             [32.2177, 35.1604],
    'קדימה-צורן':         [32.2764, 34.9125],
    'קדרון':              [31.8151, 34.7977],
    'קיסריה':             [32.5131, 34.9058],
    'קציר':               [32.4886, 35.1017],
    'קצרין':              [32.9920, 35.6877],
    'קרית ארבע':          [31.5292, 35.1166],
    'קרית טבעון':         [32.7162, 35.1268],
    'קרית ים':            [32.8502, 35.0703],
    'קרית יערים':         [31.8035, 35.1013],
    'קרית מלאכי':         [31.7316, 34.7446],
    'קרית עקרון':         [31.8608, 34.8233],
    'קרני שומרון':        [32.1710, 35.0892],
    'רבדים':              [31.7730, 34.8153],
    'רחוב':               [32.4497, 35.4900],
    'ריחן':               [32.4687, 35.1352],
    'רינתיה':             [32.0433, 34.9317],
    'רכסים':              [32.7510, 35.1014],
    'רם-און':             [32.5272, 35.2590],
    'רמות':               [31.8156, 35.1955],
    'רשפים':              [32.4819, 35.4775],
    'שבי ציון':           [32.9806, 35.0833],
    'שדה אליעזר':         [33.0459, 35.5641],
    'שדה ורבורג':         [32.2061, 34.9048],
    'שדה צבי':            [31.4485, 34.7133],
    'שדמות דבורה':        [32.6955, 35.4374],
    'שוהם':               [31.9968, 34.9464],
    'שורש':               [31.7975, 35.0651],
    'שילה':               [32.0552, 35.2995],
    'שלומי':              [33.0761, 35.1486],
    'שעל':                [33.1162, 35.7149],
    'שעלבים':             [31.8700, 34.9839],
    'שער אפרים':          [32.2890, 34.9974],
    'שער העמקים':         [32.7231, 35.1131],
    'שערי תקווה':         [32.1240, 35.0243],
    'תלמי אליהו':         [31.2300, 34.4295],
    'תלמי יוסף':          [31.1997, 34.3618],
    'תפרח':               [31.3260, 34.6825],
    'תקוע':               [31.6531, 35.2294],
    // ---- 22.9.2026, גיליון הדלקן השני ----
    'אביגדור':            [31.7109, 34.7436],
    'אביחיל':             [32.3502, 34.8717],
    'אבני איתן':          [32.8246, 35.7667],
    'בית יוסף':           [32.5588, 35.5523],
    'בית נחמיה':          [31.9758, 34.9551],
    'גני תקווה':          [32.0604, 34.8761],
    'גשור':               [32.8192, 35.7160],
    'דגניה ב\'':          [32.6999, 35.5747],
    'כרמי צור':           [31.6092, 35.1009],
    'מזכרת בתיה':         [31.8514, 34.8412],
    'מלכיה':              [33.0992, 35.5117],
    'מעגן':               [32.7067, 35.6011],
    'מעגן מיכאל':         [32.5553, 34.9167],
    'נירית':              [32.1466, 34.9844],
    'נצר חזני':           [31.8216, 34.8625],
    'עופר':               [32.6221, 34.9828],
    'עידן':               [30.8060, 35.2994],
    'עין כרמל':           [32.6770, 34.9531],
    'פורת':               [32.2763, 34.9495],
    'קידר':               [31.7546, 35.3105],
    'שפר':                [32.9433, 35.4354],
    // ---- 22.9.2026, גיליון ביטוח הרכב ----
    'אלקנה':              [32.1116, 35.0355],
    'ברכה':               [32.1924, 35.2651],
    'טללים':              [30.9919, 34.7701],
    'מנחמיה':             [32.6670, 35.5556],
    'צפרירים':            [31.6600, 34.9444],
    'רמות מאיר':          [31.8746, 34.8558],
};
