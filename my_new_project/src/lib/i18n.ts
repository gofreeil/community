...
register('he', () => Promise.resolve({
    ...
    welcome_back_body: "סייע לנו לקדם את החברה שלנו ליותר סולידית, אחראית וחופשיה!",
    default_user: "משתמש",
...
register('en', () => Promise.resolve({
    ...
    welcome_back_body: "Help us make our society more solid, responsible and free!",
    default_user: "User",
...
register('ru', () => Promise.resolve({
    ...
    welcome_back_body: "Помогите нам сделать наше общество более крепким, ответственным и свободным!",
