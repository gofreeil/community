...
import * as components from './translations/components';
import * as labels from './translations/labels';
...
register('he', () => Promise.resolve({
    ...
    welcome_joiners_title: "ברוכים המצטרפים",
    welcome_joiners_body: "נרשמת כמשתמש בפלטפורמת קהילה בשכונה. אתה מוכר כעת בכל האתרים שלנו ללא צורך הזדהות נוספת.",
    welcome_platforms_label: "יוצאים לחירות מוכיחים שעולם חדש הוא אפשרי",
    welcome_back_title: "ברוכים השבים, {name}!",
    welcome_back_body: "סייע לנו לקדם את החברה שלנו ליותר סולידרית, אחראית וחופשיה!",
    default_user: "משתמש",
    ...
    female: "👩 נקבה",
    phone_label: "טלפון",
    phone_hint: "מספר נייד ישראלי, למשל 050-1234567 (אפשר גם עם +972)",
    city_label: "עיר/ ישוב",
    choose_city: "בחר עיר",
    ...
    coordinator_neighborhood: "השכונה שלך",
    coordinator_no_neighborhood: "לא נמצאה שכונה בפרופיל שלך. עדכן את הפרופיל כדי להירשם כרכז.",
    ...
    coordinator_already_self: "ℹ️ אין אפשרות לשלוח בקשה חוזרת, כיוון שאתה כבר רכז של {area}.",
    coordinator_already_pending: "ℹ️ בקשתך להיות רכז/ת ב{area} כבר נשלחה וממתינה לאישור. הפרטים שמילאת עכשיו נשמרו על אותה בקשה — אין צורך לשלוח שוב.",
    coordinator_already_pending_when: "הבקשה נשלחה ב־{when}",
    ...
    coordinator_nb_exists: "✅ \"{name}\" כבר ברשימת השכונות של העיר — הבקשה תוגש עליה, אין צורך לסמן על המפה.",
    coordinator_name_is_phone: "בשדה השם הוקלד מספר טלפון. כתבו כאן את שמכם המלא; את הטלפון מכניסים בשדה הבא.",
...
register('en', () => Promise.resolve({
    ...
    welcome_joiners_title: "Welcome aboard!",
    welcome_joiners_body: "You're registered on the Neighborhood Community platform. You're now recognized across all our sites — no extra sign-in needed.",
    welcome_platforms_label: "Yotzim LaCherut — proving a new world is possible",
    welcome_back_title: "Welcome back, {name}!",
    welcome_back_body: "Help us make our society more solidary, responsible and free!",
    default_user: "User",
    ...
    female: "👩 Female",
    phone_label: "Phone",
    phone_hint: "Israeli mobile number, e.g. 050-1234567 (+972 also accepted)",
    ...
    coordinator_neighborhood: "Your neighborhood",
    coordinator_no_neighborhood: "No neighborhood found in your profile. Update your profile to register as a coordinator.",
    ...
    coordinator_already_self: "ℹ️ You can't submit another request — you're already the coordinator of {area}.",
    coordinator_already_pending: "ℹ️ Your request to be a coordinator in {area} has already been sent and is awaiting approval. The details you just filled in were saved to that same request — no need to send it again.",
    coordinator_already_pending_when: "Request sent on {when}",
    ...
    coordinator_nb_exists: "✅ \"{name}\" is already in this city's neighborhood list — your request will be for it, no need to mark the map.",
    coordinator_name_is_phone: "The name field contains a phone number. Enter your full name here; the phone goes in the next field.",
...
register('ru', () => Promise.resolve({
    ...
    welcome_joiners_title: "Добро пожаловать!",
    welcome_joiners_body: "Вы зарегистрированы на платформе «Сообщество района». Теперь вас узнают на всех наших сайтах — без повторной авторизации.",
    welcome_platforms_label: "Йоцим ле-Херут — доказываем, что новый мир возможен",
    welcome_back_title: "С возвращением, {name}!",
    welcome_back_body: "Помогите нам сделать наше общество более солидарным, ответственным и свободным!",
    ...
    female: "👩 Женский",
    phone_label: "Телефон",
    phone_hint: "Израильский мобильный номер, напр. 050-1234567 (можно с +972)",
    city_label: "Город/Поселение",
    ...
    coordinator_neighborhood: "Ваш район",
    coordinator_no_neighborhood: "В вашем профиле не указан район. Обновите профиль, чтобы зарегистрироваться координатором.",
    ...
    coordinator_already_self: "ℹ️ Невозможно отправить повторную заявку — вы уже координатор района {area}.",
    coordinator_already_pending: "ℹ️ Ваша заявка на должность координатора в районе {area} уже отправлена и ожидает одобрения. Данные, которые вы сейчас заполнили, сохранены в той же заявке — отправлять её повторно не нужно.",
    coordinator_already_pending_when: "Заявка отправлена {when}",
    ...
    coordinator_nb_exists: "✅ «{name}» уже есть в списке районов этого города — заявка будет на него, отмечать на карте не нужно.",
    coordinator_name_is_phone: "В поле имени указан номер телефона. Введите здесь полное имя; телефон вводится в следующем поле.",
