...
register('he', () => Promise.resolve({
    ...
    welcome_joiners_body: "נרשמת כמשתתף באחוות יוצאים לחירות — אתה מוכר עכשיו בכל הפלטפורמות והאתרים שלנו.",
    welcome_platforms_label: "כל הפלטפורמות והאתרים שלנו",
...
register('en', () => Promise.resolve({
    ...
    welcome_joiners_body: "You're registered as a member of the Yotzim LaCherut fellowship — you're now recognized across all our platforms and sites.",
    welcome_platforms_label: "All our platforms & sites",
...
register('ru', () => Promise.resolve({
    ...
    welcome_joiners_body: "Вы зарегистрированы как участник сообщества «Йоцим ле-Херут» — теперь вас узнают на всех наших платформах и сайтах.",
    welcome_platforms_label: "Все наши платформы и сайты",
