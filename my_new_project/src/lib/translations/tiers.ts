...
export const he = {
    tiers: {
        ...
        hint_phone_short: 'מספר הטלפון צריך להכיל לפחות 9 ספרות',
        field_gender: 'מין',
...
export const en = {
    tiers: {
        ...
        hint_phone_short: 'The phone number must contain at least 9 digits',
        field_gender: 'Gender',
...
export const ru = {
    tiers: {
        ...
        hint_phone_short: 'Номер телефона должен содержать не менее 9 цифр',
        field_gender: 'Пол',
