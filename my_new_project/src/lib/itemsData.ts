...
export const items: Item[] = [
    {
        ...
        label: 'גמ"ח ספרים',
        category: "gemachim",
        description: "מגוון רחב של ספרי קודש וקריאה לכל הגילאים. השאלה חינם לתקופה של עד חודש.",
        contact: "משפחת כהן",
        phone: "050-1234567",
    ...
    },
    {
        ...
        label: "ספה למסירה",
        category: "giveaway",
        description: "ספה דו-מושבית במצב מצוין, נוחה מאוד. למסירה חינם עקב מעבר דירה.",
