	...
	<div class:hidden={activeTab !== 'about'}>
		...
		<div class="mb-10 rounded-3xl p-7" style="background:linear-gradient(135deg,#0f172a,#1e293b); border:1px solid rgba(139,92,246,0.2);">
			...
			<p class="text-base md:text-lg text-gray-200 leading-relaxed mb-7">
				<span class="text-white font-black">קהילה בשכונה</span> היא פלטפורמה דיגיטלית המרכזת את כל מה שקורה בשכונה שלך — גמ"חים, עסקים מקומיים, מניינים, חוגים, אירועים, חפצים למסירה ועוד — הכל במקום אחד נגיש ונוח.
			</p>
		...
		<div class="mb-10">
			...
			<div class="grid grid-cols-2 md:grid-cols-4 gap-3">
				{#each [['🤝','ערבות הדדית','כל אחד תורם וכל אחד מקבל'],['🏛️','ביזור הכח','50% מהרווחים חוזרים לאנשים'],['🔍','שקיפות מלאה','המודל הכלכלי פתוח — כולם יודעים לאן כל שקל'],['❤️','צדקה וחסד','20% לצדקה קבועה — חברה טובה דואגת לנצרכיה']] as [ico,title,desc]}
