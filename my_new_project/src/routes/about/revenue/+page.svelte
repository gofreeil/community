...
<div class="text-white" dir="rtl">
	...
	<p class="text-lg md:text-xl font-bold leading-relaxed mt-6 mb-2">
		<button
	...
	<div class:hidden={activeTab !== 'owners'}>
		...
		<div class="mb-10">
			...
			<p class="text-gray-300 text-lg mb-6 max-w-3xl leading-relaxed">
				...
				כיצד — אנו לא מאפשרים לכל אחד לרכוש כמה מניות שהוא חפץ אלא <span class="text-blue-300 font-bold">כל בית אב רשאי לרכוש עד 4,000 מניות בלבד</span>
			</p>
			<div class="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-white/10 py-2">
				...
				<div class="pt-6 md:pt-0 md:pr-8">
					...
					<ul class="space-y-2 text-lg text-gray-300">
						...
						<li class="flex gap-2"><span class="text-emerald-400">•</span> עד 40,000 מניות — עד 4,000 למשפחה</li>
			...
			<div class="grid md:grid-cols-2 gap-5">
				...
				<div class="flex flex-col gap-2">
					{#each [
						...
						['🔄','מכירה חופשית','ניתן חופשי למכור או להעביר את המניות, בכפוף להגבלת 4,000 לבית אב'],
						['🔒','הגבלת ריכוז','עד 4,000 יחידות למשפחה גרעינית אחת — לשמר כח ביזור']
					] as [ico, title, desc]}
