...
const DEFAULT_COSTS = [
    { name: 'תפעול טכני (שרתים, דומיין, API)', pct: '15%' },
    { name: 'פיתוח, תחזוקה שוטפת ואבטחת מידע', pct: '10%' },
    { name: 'שירות לקוחות ותמיכה למפרסמים',      pct: '10%' },
];
...
const DEFAULT_DISTRIBUTION = [
    ...
    { emoji: '🏛️', pct: '50%', title: 'בעלי הפלטפורמה', desc: 'תמורה על ההשקעה וההובלה של המיזם לאורך זמן.', from: '#1e3a8a', to: '#3b82f6', link: '#section-5' },
