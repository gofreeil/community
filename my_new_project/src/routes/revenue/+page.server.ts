...
const DEFAULT_CHANNELS = [
    ...
    { icon: '🏛️', bg: 'rgba(234,179,8,0.15)',   color: '#facc15', title: 'אולמות לאירועים', desc: 'השכרת אולמות ומקומות לאירועים שכונתיים — חתונות, ימי הולדת, כנסים.', tag: 'עמלה' },
    ...
    { icon: '💑', bg: 'rgba(236,72,153,0.15)',  color: '#f472b6', title: 'פנויים ופנויות',  desc: 'פלטפורמת היכרויות שכונתית — חיבור בין רווקים ורווקות מהקהילה.', tag: 'עמלה' },
    { icon: '💼', bg: 'rgba(14,165,233,0.15)',  color: '#38bdf8', title: 'דרושים לעבודה',   desc: 'לוח דרושים שכונתי — עסקים מקומיים מפרסמים משרות לתושבים.', tag: 'פרסום' },
];
