...
<div class="text-white" dir="rtl">
	...
	<div class:hidden={activeTab !== 'about'}>
		...
		<div class="mb-10 rounded-3xl p-7" style="background:linear-gradient(135deg,#0f172a,#1e293b); border:1px solid rgba(139,92,246,0.2);">
			...
			<!-- קו מפריד -->
			<div class="mb-7" style="height:1px; background:rgba(139,92,246,0.25);"></div>
			...
			<ul class="space-y-4 mb-6">
				{#each [
					['המיזם פועל לפי מודל כלכלי-חברתי ייחודי שבו חצי מהרווחים חוזרים אל הקהילה: 30% לרכזי השכונות, 20% לצדקה ולחסד','#a78bfa'],
