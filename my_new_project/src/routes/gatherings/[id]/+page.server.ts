...
import {
    getGatheringById, updateGathering, deleteGathering, getUserById,
...
export const actions: Actions = {
    ...
    updateDetails: async (event) => {
        ...
        await updateGathering(gathering.id, { title, date, time, location, description });
        return { success: true, action: 'detailsUpdated' };
    },

    // ── מנהל/יוצר ממנה מגיע נוסף למנהל ──
