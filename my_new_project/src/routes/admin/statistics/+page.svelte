<script lang="ts">
	...
	// ---- סדרות חודשיות של השנה הנוכחית (לגרפים המפורטים) ----
	// הגרף המסכם ("הגרף הראשי") עבר לרכיב המשותף StatsSummaryChart.
...
<div class="min-h-screen bg-[#070b14] text-white" dir="rtl">
	<div class="max-w-3xl mx-auto px-4 py-8">
		...
		<!-- גרף מסכם ("הגרף הראשי"): כניסות + פריטים + נרשמים, עם קישורים לפירוט.
		     אותו רכיב משותף המוטמע גם בלוח הניהול (/admin). -->
		<div class="mb-6">
			<StatsSummaryChart stats={data.stats} itemsSummary={data.itemsSummary} registrations={data.registrations} />
		</div>
